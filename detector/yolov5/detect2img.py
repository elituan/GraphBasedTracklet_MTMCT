...
def detect(save_img=False):
    ...
    # webcam = True or False (True if number, end with txt or start with 'rtsp://'
    webcam = source.isnumeric() or source.endswith('.txt') or source.lower().startswith(
        ('rtsp://', 'rtmp://', 'http://'))

    # Directories
    # save_dir = AIC21-MTMC/datasets/detect_merge/c041
...
if __name__ == '__main__':
    ...
    cfg.freeze()
    # opt.source = AIC21-MTMC/datasets/detection/images/test/S06/(c041 c042 c043 c044 c045 c046)/img1/
    opt.source = f'{cfg.DET_SOURCE_DIR}/{opt.name}/img1/'
    # opt.project = AIC21-MTMC/datasets/detect_merge/
